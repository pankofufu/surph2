...
export const CarouselComponents = (left: boolean, right: boolean): ActionRow => {
    return {
        type: 1,
        components: [
            { custom_id: 'left', /* Left arrow */ type: 2, style: 2, emoji: {name: '⬅'}, disabled: left },
            { custom_id: 'right', /* Right arrow */ type: 2, style: 2, emoji: {name: '➡'}, disabled: right }
        ]
    }
}
