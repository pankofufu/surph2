/* 
  ...
  - https://github.com/detritusjs/client/blob/master/src/utils/markup.ts
  I have modified it for my own use and it's probably very broken now
*/

enum MarkupTimestampStyles {
    BOTH_LONG = 'F',
    BOTH_SHORT = 'f',
    DATE_LONG = 'D',
    DATE_SHORT = 'd',
...
export function codestring(text: string, options: MarkupFilterOptions = {}): string {
  let wrap: any /* LOL */ = Strings.CODESTRING;
